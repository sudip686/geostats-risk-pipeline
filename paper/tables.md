...
| Dip | 0 | 32 | 58 | degrees |
| Nugget (C0) | 0.21 | 0.21 | 0.21 | dimensionless |
| Structured Sill (C) | 0.83 | 0.83 | 0.83 | dimensionless |
| Total Sill (C0 + C) | 1.03 | 1.03 | 1.03 | dimensionless |
| Range (a) | 100.0 | 100.0 | 100.0 | m |
...
| Parameter | Value | Units |
|-----------|-------|-------|
| Number of Realizations | 50 | count |
| Random Seed | 1337 | - |
| Kriging Type | Ordinary Kriging | - |
| Search Neighborhood | Anisotropic local ellipsoid (120 x 80 x 20 m) | - |
| Minimum Neighbors | 4 | count |
| Maximum Neighbors | 16 | count |
...
|---|---|---|---|---|---|
| 0 | 0.34 | 0.34 | 0.34 | 2.03 | 7 |
| 1 | 0.34 | 0.34 | 0.34 | 2.03 | 7 |
| 2 | 0.17 | 0.18 | 0.19 | 2.29 | 4 |
